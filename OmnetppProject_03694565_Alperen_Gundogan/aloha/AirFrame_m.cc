...
void AirFrame::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->pktNum);
    doParsimUnpacking(b,this->senderId);
    doParsimUnpacking(b,this->isAck);
}

const char * AirFrame::getSenderName() const
{
    return this->senderName.c_str();
}

void AirFrame::setSenderName(const char * senderName)
{
    this->senderName = senderName;
}

int AirFrame::getPktNum() const
{
    return this->pktNum;
}

void AirFrame::setPktNum(int pktNum)
{
    this->pktNum = pktNum;
}

int AirFrame::getSenderId() const
{
    return this->senderId;
}

void AirFrame::setSenderId(int senderId)
{
    this->senderId = senderId;
}

bool AirFrame::getIsAck() const
{
    return this->isAck;
}

void AirFrame::setIsAck(bool isAck)
{
    this->isAck = isAck;
}
...
AirFrameDescriptor::AirFrameDescriptor() : omnetpp::cClassDescriptor("aloha::AirFrame", "omnetpp::cPacket")
{
...
int AirFrameDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='p' && strcmp(fieldName, "pktNum")==0) return base+1;
    if (fieldName[0]=='s' && strcmp(fieldName, "senderId")==0) return base+2;
    if (fieldName[0]=='i' && strcmp(fieldName, "isAck")==0) return base+3;
...
std::string AirFrameDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return long2string(pp->getPktNum());
        case 2: return long2string(pp->getSenderId());
        case 3: return bool2string(pp->getIsAck());
        default: return "";
    }
}
...
bool AirFrameDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setPktNum(string2long(value)); return true;
        case 2: pp->setSenderId(string2long(value)); return true;
        case 3: pp->setIsAck(string2bool(value)); return true;
